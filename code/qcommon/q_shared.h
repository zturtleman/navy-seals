...
//
#define	BUTTON_ATTACK		1			// ZTM: NOTE: +attack command
#define	BUTTON_TALK			2			// displays talk balloon and disables actions
#define	BUTTON_USE			4			// ZTM: NOTE: +useitem command
#define	BUTTON_GESTURE		8			// ZTM: NOTE: +salute command
#define	BUTTON_WALKING		16			// walking can't just be infered from MOVE_RUN
// because a key pressed late in the frame will
// only generate a small move value for that frame
// walking will use different animations and
// won't generate footsteps
#define	BUTTON_SPRINT		32			// ZTM: NOTE: +sprint command
#define	BUTTON_WEAPON1		64			// ZTM: NOTE: +activate command

#define	BUTTON_ANY			128			// any key whatsoever

// ET's "wbuttons"
#define	BUTTON_WEAPON2		( 1 << 8 )	// ZTM: NOTE: +attack2 command
#define	BUTTON_WEAPON3		( 1 << 9 )	// ZTM: NOTE: +zoom command
//#define	BUTTON_UNUSED		( 1 << 10 ) // ZTM: unused in ET. I'm not sure it can be used as there is no "+command" to enable it
#define	BUTTON_RELOAD		( 1 << 11 )	// ZTM: NOTE: +reload command
//#define	BUTTON_LEANLEFT	( 1 << 12 ) // ZTM: NOTE: +leanleft command
//#define	BUTTON_LEANRIGHT	( 1 << 13 ) // ZTM: NOTE: +leanright command
//#define	BUTTON_UNUSED2	( 1 << 14 )
#define	BUTTON_IRONSIGHT	( 1 << 15 ) // ZTM: NOTE: +prone command
...
typedef struct usercmd_s {
	int serverTime;
#if 1 // NSCO-ET: let's not split logic to use "wbuttons" for no reason
